	            ...
	            <div class="card-body">
					...
					<div class="form-group mb-3">
						...
						<select class="form-control select2" id="featured" name="featured">
							<option value="0" <?php if ( $movie_detail->featured == 0) echo 'selected';?>><?php echo get_phrase('select_No');?></option>
							<option value="1" <?php if ( $movie_detail->featured == 1) echo 'selected';?>><?php echo get_phrase('select_Yes');?></option>
						</select>
					</div>
	            </div>
	        </div>
		...
		<div class="col-6">
			<div class="row">
				<div class="form-group col-6">
					<input type="submit" class="btn btn-success col-12" value="<?php echo get_phrase('update_movie'); ?>">
				</div>
				<div class="col-6">
					<a href="<?php echo base_url();?>index.php?admin/movie_list" class="btn btn-secondary col-12"><?php echo get_phrase('Go_Back'); ?></a>
				</div>
			</div>
		</div>
	</div>
