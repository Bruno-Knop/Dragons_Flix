<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title"><?php echo get_phrase('Subscription_history'); ?></h4>
                ...
                <table id="basic-datatable" class="table dt-responsive nowrap" width="100%">
					<thead>
						<tr>
							...
							<th><?php echo get_phrase('Method'); ?>Method</th>
							<th><?php echo get_phrase('User_Purchased'); ?></th>
						</tr>
					</thead>
					<tbody>
						<?php
				...
				<div style="text-align: center;">
					<?php echo get_phrase('Total_sale'); ?> : <?php echo '$' . $total_sale;?>
				</div>
            </div>
        </div>
    </div>
