	...
	<div class="col-md-4 col-sm-12 ">
		...
		<div class="card widget-flat">
			...
			<div class="card-body">
				...
				<h5 class="text-muted font-weight-normal mt-0" title="Number of Customers"><?php echo get_phrase('total_series'); ?></h5>
		...
		<div class="card widget-flat">
			...
			<div class="card-body">
				...
				<div class="float-right">
					...
					<i class="mdi mdi-mushroom widget-icon"></i>

				</div>

				<h5 class="text-muted font-weight-normal mt-0" title="Number of Customers"><?php echo get_phrase('total_animes'); ?></h5>

				<h3 class="mt-3 mb-3"><?php echo $this->db->from('animes')->count_all_results();?></h3>
	...
	<div class="col-md-4 col-sm-12 ">
		...
		<div class="card widget-flat">
			...
			<div class="card-body">
				...
				<h3 class="mt-3 mb-3"><?php echo $this->db->from('animes_episode')->count_all_results();?></h3>
