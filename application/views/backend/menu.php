           ...
           <div class="left-side-menu" style="background: linear-gradient(135deg,#0F2027 0,#2C5364 60%) !important;">
               ...
               <div class="slimscroll-menu">
                   ...
                   <ul class="metismenu side-nav">
                       ...
                       <li class="side-nav-item <?php if ($page_name == 'series_list' || $page_name == 'series_edit' || $page_name == 'series_create')echo 'active';?>">

                           <a href="<?php echo base_url();?>index.php?admin/series_list" class="side-nav-link  <?php if ($page_name == 'series_list' || $page_name == 'series_edit' || $page_name == 'series_create')echo 'active';?>">
                       ...
                       <li class="side-nav-item <?php if ($page_name == 'animes_list' || $page_name == 'animes_create' || $page_name == 'animes_edit' || $page_name == 'season_edit')echo 'active';?>">

                           <a href="<?php echo base_url();?>index.php?admin/animes_list" class="side-nav-link <?php if ($page_name == 'animes_list' || $page_name == 'animes_create' || $page_name == 'animes_edit' || $page_name == 'season_edit')echo 'active';?>">

                               <i class="mdi mdi-mushroom"></i>

                               <span> <?php echo get_phrase('animes'); ?> </span>
