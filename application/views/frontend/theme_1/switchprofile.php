...
<div class="lading_selection" style="height:100vh;width:100%; background-color: #141414;">
		...
		<table align="center" style="background-color: #141414;">
			...
			<tr>
				...
				<td>
					...
					<img src="<?php echo base_url();?>/assets/global/user_thumb/thumb1.png" class="profile_switcher_img" />
				...
				<td>
					...
					<img src="<?php echo base_url();?>/assets/global/user_thumb/thumb2.png" class="profile_switcher_img" />
				...
				<td>
					...
					<img src="<?php echo base_url();?>/assets/global/user_thumb/thumb3.png" class="profile_switcher_img" />
				...
				<td>
					...
					<img src="<?php echo base_url();?>/assets/global/user_thumb/thumb4.png" class="profile_switcher_img" />
