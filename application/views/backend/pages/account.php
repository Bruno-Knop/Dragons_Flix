            ...
            <div class="card-body">
				...
				<form method="post" action="<?php echo base_url();?>index.php?admin/account" enctype="multipart/form-data">
					...
					<div class="form-group mb-3">
						<label for="simpleinput1"><?php echo get_phrase('Your_name'); ?></label>
						<input type="text" class="form-control" id = "simpleinput1" name="name" value="<?php echo $user_detail->name;?>">
					</div>
					<div class="form-group mb-3">
						<label for="simpleinput2"><?php echo get_phrase('Your_email'); ?></label>
        ...
        <div class="card">
            <div class="card-body">
				...
				<form method="post" action="<?php echo base_url();?>index.php?admin/account" enctype="multipart/form-data">
					...
					<div class="form-group mb-3">
	                    <label for="simpleinput3"><?php echo get_phrase('New_password'); ?></label>
	                    <input type="password" class="form-control" id = "simpleinput3" name="new_password" value="">
	                </div>
					<div class="form-group mb-3">
	                    <label for="simpleinput4"><?php echo get_phrase('Current_password'); ?></label>
